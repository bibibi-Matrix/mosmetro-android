...
/**
 * Visible WebView used by the authorization research mode. The user
 * completes the captive portal authorization manually while every
 * request made by the portal passes through the provided Client and
 * is written to the log.
 *
 * The Activity polls generate_204 every 10 seconds and finishes as
 * soon as the Internet connection opens, reporting the result through
 * setState(). The system back button reports cancellation.
 */
public class ResearchActivity extends Activity {
    public static final String EXTRA_URL = "url";

    // Research mode state, shared with ResearchWV provider
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle(R.string.pref_debug_research);
    ...
    /**
     * Polls generate_204 every 10 seconds; when the connection opens,
    ...
    private void startPolling() {
        ...
        poll[0] = () -> new Thread(() -> {
            ...
            handler.post(() -> {
                ...
                if (result) {
                    Logger.log(this, "Research | Connection opened");
    ...
    public void onBackPressed() {
        Logger.log(this, "Research | Cancelled by user");
